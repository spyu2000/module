 ...
 * @version $Revision: 1.1 $ $Date: 2009/08/13 11:07:12 $
 */

public final class ClassLoaderFactory {

	public static final Integer IS_DIR = new Integer(0);
	public static final Integer IS_JAR = new Integer(1);
	public static final Integer IS_GLOB = new Integer(2);
	public static final Integer IS_URL = new Integer(3);
